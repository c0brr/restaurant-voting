...
import static ru.erulaev.restaurantvoting.user.web.data.MenuTestData.MENU_1_ID;
import static ru.erulaev.restaurantvoting.user.web.data.MenuTestData.MENU_2_ID;
